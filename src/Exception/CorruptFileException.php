...
class CorruptFileException extends \RuntimeException
{
     ...
     * @return self
     */
    public static function missingChunk($expectedIndex): CorruptFileException
    {
     ...
     * @return self
     */
    public static function unexpectedIndex($index, $expectedIndex): CorruptFileException
    {
     ...
     * @return self
     */
    public static function unexpectedSize($size, $expectedSize): CorruptFileException
    {
